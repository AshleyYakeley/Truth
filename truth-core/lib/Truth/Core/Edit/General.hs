module Truth.Core.Edit.General where
{
    ...
    funcGeneralFunction :: forall edita editb. (Edit edita,FullSubjectReader (EditReader edita),FullEdit editb) =>
        (EditSubject edita -> EditSubject editb) -> GeneralFunction edita editb;
    funcGeneralFunction = MkCloseState . funcEditFunction;

    convertGeneralFunction :: forall edita editb. (EditSubject edita ~ EditSubject editb,Edit edita,FullSubjectReader (EditReader edita),FullEdit editb) =>
    ...
    constGeneralFunction :: forall edita editb. (SubjectReader (EditReader editb)) =>
        EditSubject editb -> GeneralFunction edita editb;
