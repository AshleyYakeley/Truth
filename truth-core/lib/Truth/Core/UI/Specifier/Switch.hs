...
data SwitchUISpec sel edit where
    MkSwitchUISpec :: UpdateFunction edit (WholeEdit (UISpec sel edit)) -> SwitchUISpec sel edit
...
switchUISpec :: UpdateFunction edit (WholeEdit (UISpec sel edit)) -> UISpec sel edit
