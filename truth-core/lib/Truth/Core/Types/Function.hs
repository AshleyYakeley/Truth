...
functionLiftEditLens (MkCloseUnlift (unlift :: Unlift t) (MkAnEditLens auf pe)) = let
...
applyFunctionUpdateFunction = MkCloseUnlift identityUnlift applyFunctionAnUpdateFunction
