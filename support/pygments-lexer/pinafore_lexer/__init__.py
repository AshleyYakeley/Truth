...
class PinaforeLexer(RegexLexer):
    ...
    tokens = {
        'root': [
            ...
            (r'"(\\\\|\\"|[^"])*"', String),
            (words(('fn', 'fns', 'match', 'rec', 'if', 'then', 'else', 'let', 'import', 'expose', 'in', 'do', 'case', 'of', 'end'), suffix=r'\b'), Keyword),
            ...
            (words((
                ...
                'Unit', 'Maybe', 'List', 'List1', 'RefOrder', 'Action', 'WholeRef', 'SetRef', 'FiniteSetRef', 'ListRef', 'TextRef', 'Context', 'Element', 'Window', 'MenuItem'
