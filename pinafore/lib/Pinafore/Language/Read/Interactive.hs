...
showTypeInteractiveCommand :: Bool -> Parser (InteractiveCommand baseupdate)
...
simplifyTypeInteractiveCommand :: Parser (InteractiveCommand baseupdate)
...
readInteractiveCommand :: Parser (InteractiveCommand baseupdate)
