...
subtypeSS ::
       PinaforeSingularType 'Negative p -> PinaforeSingularType 'Positive q -> PinaforeTypeCheck (PinaforeShim Type p q)
...
subtypeST :: PinaforeSingularType 'Negative p -> PinaforeType 'Positive q -> PinaforeTypeCheck (PinaforeShim Type p q)
...
subtypeTT :: PinaforeType 'Negative p -> PinaforeType 'Positive q -> PinaforeTypeCheck (PinaforeShim Type p q)
...
invertedSubtype :: PinaforeType 'Negative p -> PinaforeType 'Positive q -> PinaforeTypeCheck (PinaforeShim Type p q)
