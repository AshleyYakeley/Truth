...
renameExpression ::
       Namespace ns
    => NamedExpression name (NamespaceNegWitness ns) t
    -> ns (NamedExpression name (NamespaceNegWitness ns) t)
renameExpression (ClosedExpression a) = return (ClosedExpression a)
