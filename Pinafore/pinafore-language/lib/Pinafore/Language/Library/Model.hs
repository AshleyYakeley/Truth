...
-- WModel
instance
    (HasQType QPolyShim 'Positive t, HasQType QPolyShim 'Negative t) =>
    HasQType QPolyShim 'Positive (WModel (WholeUpdate (Know t)))
    where
    qType = mapPosShimWit (functionToShim "wModelToWholeModel" wModelToWholeModel) qType

instance
    (HasQType QPolyShim 'Positive t, HasQType QPolyShim 'Negative t) =>
    HasQType QPolyShim 'Negative (WModel (WholeUpdate (Know t)))
    where
    ...
    headingBDS
        ...
        , headingBDS
            ...
            , hasSubtypeRelationBDS Verify ""
                $ functionToShim "WholeModel to Model"
                $ langWholeModelToModel @BottomType @TopType
            , namespaceBDS "WholeModel"
                ...
                <> [ valBDS
                   ...
                   , addNameInRootBDS
                        $ valBDS "known" "True if the whole model is known."
                        $ \(val :: WROWModel (Know TopType)) ->
        ...
        , headingBDS
            ...
            , namespaceBDS
                ...
                , addNameInRootBDS
                    $ valBDS "member" "A model of the membership of a value in a set."
                    $ langSetModelMember @A
        ...
        , headingBDS
            ...
            , hasSubtypeRelationBDS Verify ""
                $ functionToShim "FiniteSetModel to SetModel"
                $ langFiniteSetModelToSetModel @A @TopType
            , namespaceBDS
                "FiniteSetModel"
                [ valBDS
                    "coMap"
                ...
                , addNameInRootBDS
                    $ valBDS "<:+:>" "Cartesian sum of finite sets."
                    $ langFiniteSetModelCartesianSum @AP @AQ @BP @BQ
                , addNameInRootBDS
        ...
        , headingBDS
            ...
            , hasSubtypeRelationBDS TrustMe ""
                $ functionToShim "langListModelToModel"
                $ langListModelToModel @BottomType @TopType
