    ...
    headingBDT
        ...
        , headingBDT
              ...
              , namespaceBDT
                    ...
                    , valBDT "list" "All members of a finite set, by an order." $ finiteSetGetOrdered @A
                    , valBDT
                          "getList"
                          "Get all members of a finite set, by an order. \
                                    \The resulting `ListModel` will behave more \"list-like\" than `list.FiniteSetModel`."
        ...
        , headingBDT
              ...
              , namespaceBDT
                    "ListModel"
                    ""
                    [ valBDT "whole" "Represent a whole model as a list model." $ langWholeModelToListModel @A
        ...
        , headingBDT
              ...
              , namespaceBDT
                    "TextModel"
                    ""
                    [ valBDT "whole" "Represent a whole model as a text model." langWholeModelToTextModel
