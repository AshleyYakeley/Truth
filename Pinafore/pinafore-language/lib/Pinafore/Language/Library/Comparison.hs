    ...
    headingBDS
        ...
        , headingBDS
            ...
            , hasSubtypeRelationBDS @(Preorder A) @(Equivalence A) Verify ""
                $ functionToShim "preorderEquivalence"
                $ preorderEquivalence @A
            , namespaceBDS
                "Preorder"
        ...
        , headingBDS
            ...
            , namespaceBDS "Order"
                ...
                <> [ valBDS "map" "Map an order by a function" (contramap :: (B -> A) -> Order A -> Order B)
                   ...
                   , addNameInRootBDS
                        $ valBDS "indiscrete" "The total preorder that sees all things as equivalent."
                        $ indiscreteOrder @A
