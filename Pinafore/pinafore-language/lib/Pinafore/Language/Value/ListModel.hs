...
langListModelRead :: LangListModel '( p, q) -> ReadM (ListReader (WholeReader q)) t -> PinaforeAction t
...
langListModelGetCount :: LangListModel '( BottomType, TopType) -> PinaforeAction Int64
langListModelGetCount model = fmap unSequencePoint $ langListModelRead model $ readM ListReadLength

langListModelGetItem :: forall q. Int64 -> LangListModel '( BottomType, q) -> PinaforeAction q
...
langListModelInsert :: forall p. Int64 -> p -> LangListModel '( p, TopType) -> PinaforeAction ()
...
langListModelSet :: forall p. Int64 -> p -> LangListModel '( p, TopType) -> PinaforeAction ()
...
langListModelDelete :: Int64 -> LangListModel '( BottomType, TopType) -> PinaforeAction ()
...
langListModelClear :: LangListModel '( BottomType, TopType) -> PinaforeAction ()
