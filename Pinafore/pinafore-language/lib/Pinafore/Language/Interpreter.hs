...
getBindingInfoMap :: Interpreter ts (FullNameRef -> Maybe (BindingInfo ts))
...
withCurrentNamespace :: Namespace -> ScopeInterpreter ts (ScopeInterpreter ts ())
withCurrentNamespace ns = do
