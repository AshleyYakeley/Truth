...
exprShowPrecGroundType ::
    ...
    (IsDolanGroundType ground, GroundExprShow ground) =>
    ground dv gt ->
    PrecNamedText
...
instance
    ...
    (GroundExprShow ground, Is PolarityType polarity) =>
    ExprShow (DolanGroundedType ground polarity t)
    where
...
instance
    forall (ground :: GroundTypeKind) (polarity :: Polarity) t.
    (GroundExprShow ground, Is PolarityType polarity) =>
    ExprShow (DolanSingularType ground polarity t)
    where
...
instance
    ...
    (GroundExprShow ground, Is PolarityType polarity) =>
    AllConstraint ExprShow (DolanGroundedType ground polarity)
    where
    allConstraint = Dict
...
instance
    forall (ground :: GroundTypeKind) (polarity :: Polarity) t.
    (GroundExprShow ground, Is PolarityType polarity) =>
    ExprShow (DolanType ground polarity t)
    where
...
instance
    forall (ground :: GroundTypeKind) (polarity :: Polarity).
    (GroundExprShow ground, Is PolarityType polarity) =>
    AllConstraint ExprShow (DolanType ground polarity)
    where
    allConstraint = Dict
...
instance
    forall (ground :: GroundTypeKind) (polarity :: Polarity) t.
    (GroundExprShow ground, Is PolarityType polarity) =>
    ExprShow (RangeType (DolanType ground) polarity t)
    where
...
instance
    ...
    (IsDolanGroundType ground, GroundExprShow ground) =>
    ExprShow (NonpolarType ground t)
    where
    exprShowPrec npt =
...
instance
    ...
    (IsDolanGroundType ground, GroundExprShow ground) =>
    AllConstraint ExprShow (NonpolarType ground)
    where
    allConstraint = Dict
...
instance
    forall (ground :: GroundTypeKind) t.
    (IsDolanGroundType ground, GroundExprShow ground) =>
    ExprShow (NonpolarGroundedType ground t)
    where
    exprShowPrec npt =
...
instance
    forall (ground :: GroundTypeKind).
    (IsDolanGroundType ground, GroundExprShow ground) =>
    AllConstraint ExprShow (NonpolarGroundedType ground)
    where
    allConstraint = Dict
