...
pattern MkPerceptualSRGBFraction r g b <-
    ...
    where
        MkPerceptualSRGBFraction r g b =
...
pattern MkAlphaColour16 op col <-
    ...
    where
        MkAlphaColour16 op col = addAlpha col $ clamp16 op
...
pattern MkAlphaColourFraction op col <-
    ...
    where
        MkAlphaColourFraction op col = addAlpha col $ doubleToW16 op
    ...
    headingBDS "Colour" ""
        $ [ typeBDS
                ...
                [ valPatBDS
                    ...
                    $ PureFunction
                    $ pure
                    $ \(MkPerceptualSRGB16 r g b) -> (r, (g, (b, ())))
                , valPatBDS
                    "SRGBF"
          ...
          , typeBDS
                ...
                , valPatBDS
                    ...
                    $ PureFunction
                    $ pure
                    $ \(MkAlphaColourFraction op col) -> (op, (col, ()))
                ]
