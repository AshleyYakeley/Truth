...
applyModelMorphism mmod = modelBasedModel mmod $ applyStorageLens
...
applyInverseModelMorphism mmod = modelBasedModel mmod $ applyInverseStorageLens
...
applyInverseModelMorphismSet ::
    ...
    -> WModel (FiniteSetUpdate a)
applyInverseModelMorphismSet mmod = modelBasedModel mmod $ applyInverseStorageLensSet
