...
data VarMatch =
    forall t. MkVarMatch (TypeVarT t)
                         (TypeVarT t)
...
instance forall (ground :: GroundTypeKind) polarity dv gt. (IsDolanGroundType ground, Is PolarityType polarity) =>
             MatchedEquality (CCRArguments (CCRPolarArgument (DolanType ground) polarity) dv gt) where
...
instance forall (ground :: GroundTypeKind) polarity. (IsDolanGroundType ground, Is PolarityType polarity) =>
             MatchedEquality (DolanType ground polarity) where
...
instance forall (ground :: GroundTypeKind) polarity. (IsDolanGroundType ground, Is PolarityType polarity) =>
             MatchedEquality (DolanGroundedType ground polarity) where
...
instance forall (ground :: GroundTypeKind) polarity. (IsDolanGroundType ground, Is PolarityType polarity) =>
             MatchedEquality (DolanSingularType ground polarity) where
