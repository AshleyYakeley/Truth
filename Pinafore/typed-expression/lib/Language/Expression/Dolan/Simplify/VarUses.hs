...
instance
    forall (ground :: GroundTypeKind) polarity cat wit.
    GetVarUses ground wit =>
    GetVarUses ground (PolarShimWit cat wit polarity)
    where
...
instance
    ...
    (IsDolanGroundType ground, Is PolarityType polarity) =>
    GetVarUses ground (CCRPolarArguments dv (DolanType ground) gt polarity)
    where
...
instance
    forall (ground :: GroundTypeKind) polarity.
    (IsDolanGroundType ground, Is PolarityType polarity) =>
    GetVarUses ground (DolanGroundedType ground polarity)
    where
...
instance
    forall (ground :: GroundTypeKind) polarity.
    (IsDolanGroundType ground, Is PolarityType polarity) =>
    GetVarUses ground (DolanSingularType ground polarity)
    where
...
instance
    forall (ground :: GroundTypeKind) polarity.
    (IsDolanGroundType ground, Is PolarityType polarity) =>
    GetVarUses ground (DolanType ground polarity)
    where
...
getArgExpressionVars ::
    forall (ground :: GroundTypeKind) polarity sv a.
    (IsDolanGroundType ground, Is PolarityType polarity) =>
...
getArgsExpressionVars ::
    forall (ground :: GroundTypeKind) polarity dv gt t.
    (IsDolanGroundType ground, Is PolarityType polarity) =>
...
instance
    forall (ground :: GroundTypeKind) polarity.
    (IsDolanGroundType ground, Is PolarityType polarity) =>
    GetExpressionVars (DolanGroundedType ground polarity)
    where
...
instance
    forall (ground :: GroundTypeKind) polarity.
    (IsDolanGroundType ground, Is PolarityType polarity) =>
    GetExpressionVars (DolanSingularType ground polarity)
    where
...
instance
    forall (ground :: GroundTypeKind) polarity.
    (IsDolanGroundType ground, Is PolarityType polarity) =>
    GetExpressionVars ((DolanType ground) polarity)
    where
