...
mapWitnesses ::
    forall k (poswit :: k -> Type) (negwit :: k -> Type) (a :: Type).
    WitnessMappable poswit negwit a =>
    Endo' poswit ->
    Endo' negwit ->
    Endo a
...
instance
    (WitnessMappable poswit negwit p, WitnessMappable poswit negwit q) =>
    WitnessMappable poswit negwit (Either p q)
    where
    mapWitnessesM mapPos mapNeg = mapWitnessesM mapPos mapNeg <+++> mapWitnessesM mapPos mapNeg
...
mapPShimWitsM ::
    forall m shim wit a.
    (Category shim, Applicative m, PShimWitMappable shim wit a) =>
...
mapPShimWits ::
    forall shim wit a.
    (Category shim, PShimWitMappable shim wit a) =>
...
class
    (forall a. WitnessMappable poswit negwit (f a)) =>
...
instance
    (forall t. WitnessMappable poswit negwit (w t), forall t. WitnessMappable poswit negwit (c a t)) =>
    WitnessMappable poswit negwit (Pattern w c a b)
    where
...
instance
    ( forall t. WitnessMappable poswit negwit (patwit t)
    , forall t. WitnessMappable poswit negwit (expwit t)
    , forall t. WitnessMappable poswit negwit (funcwit t)
    ) =>
    WitnessMappable poswit negwit (SealedPattern patwit expwit funcwit a)
    where
    mapWitnessesM mapPos mapNeg =
...
instance
    ...
    WitnessMappable (poswit :: Type -> Type) (negwit :: Type -> Type) (PatternConstructor patwit expwit funcwit poswit)
    where
    mapWitnessesM mapPos mapNeg =
...
instance
    (forall t. WitnessMappable poswit negwit (varw t)) =>
    WitnessMappable poswit negwit (SealedExpression varw poswit)
    where
    mapWitnessesM mapPos mapNeg =
...
instance
    (forall t. WitnessMappable poswit negwit (varw t)) =>
    WitnessMappable poswit negwit (SealedPartialExpression varw poswit)
    where
    mapWitnessesM mapPos mapNeg =
...
instance
    (forall t. WitnessMappable poswit negwit (varw t)) =>
    WitnessMappable poswit negwit (SealedFExpression varw poswit f)
    where
    mapWitnessesM mapPos mapNeg =
