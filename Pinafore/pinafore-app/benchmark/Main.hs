...
benchScripts =
    bgroup
        ...
        , benchScript
              "let import UI; const a b = a; ui_labelled n ui = horizontal [label n, layoutGrow ui] in const (return ()) $ ui_labelled {\"Address: \"} $ ui_labelled {\"Address: \"} $ ui_labelled {\"Address: \"} $ ui_labelled {\"Address: \"} $ ui_labelled {\"Address: \"} UI.blank"
