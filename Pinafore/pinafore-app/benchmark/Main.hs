...
benchScripts =
    bgroup
        ...
        , benchScript
              "let import \"pinafore-gnome\"; const = fns a b => a; ui_labelled = fns n ui => horizontal [label n, layoutGrow ui] in const (return ()) $ ui_labelled {\"Address: \"} $ ui_labelled {\"Address: \"} $ ui_labelled {\"Address: \"} $ ui_labelled {\"Address: \"} $ ui_labelled {\"Address: \"} GTK.blank"
