...
readTypeParameter =
    fmap PositiveSyntaxTypeParameter readPositiveParameter
        <|> fmap NegativeSyntaxTypeParameter readNegativeParameter
        <|> ( readParen
                $ ( do
        ...
        $ case storable of
            Just () -> do
                ...
                return
                    ...
                    $ StorableDatatypeSyntaxRecursiveTypeDeclaration parameters constructors
            Nothing -> do
        ...
        <|> readWithSourcePos
            ( do
                ...
                case sname of
                    ...
                    "declarations" -> readBracketed TokOpenBrace TokCloseBrace $ fmap SEQuoteDeclarations $ readLines readDeclaration
                    _ -> mzero
            )
        <|> readWithSourcePos
            ( do
