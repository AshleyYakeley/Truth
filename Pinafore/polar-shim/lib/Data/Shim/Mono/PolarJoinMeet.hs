...
iPolarL1 ::
    forall (shim :: ShimKind Type) polarity a.
    (JoinMeetIsoShim shim, Is PolarityType polarity) =>
...
iPolarPair ::
    forall (shim :: ShimKind Type) polarity a1 a2 b1 b2.
    (JoinMeetIsoShim shim, Is PolarityType polarity) =>
...
iPolarSwapL ::
    forall (shim :: ShimKind Type) polarity a b c.
    (JoinMeetIsoShim shim, Is PolarityType polarity) =>
...
iPolarSwap4 ::
    forall (shim :: ShimKind Type) polarity a b c d.
    (JoinMeetIsoShim shim, Is PolarityType polarity) =>
...
polarLimit ::
    forall (shim :: ShimKind Type) polarity a.
    (Is PolarityType polarity, JoinMeetShim shim) =>
...
polarF ::
    forall (shim :: ShimKind Type) polarity a b r.
    (Is PolarityType polarity, JoinMeetShim shim) =>
