...
type CCRArgumentShimWit :: ShimKind Type -> CCRArgumentKind -> Polarity -> CCRArgumentKind
type CCRArgumentShimWit shim w polarity sv = CCRShimWit (PolarShim shim polarity) w sv
...
type CCRPolarArgumentShimWit :: ShimKind Type -> (Polarity -> Type -> Type) -> Polarity -> CCRArgumentKind
...
mapCCRPolarArgumentShimWit f (ContraCCRPolarArgument arg) =
    withInvertPolarity @polarity $ do
        ...
        return $ MkShimWit (ContraCCRPolarArgument arg') $ mkContravariantPolarShim conv
...
mergeCCRPolarArgumentShimWit f (ContraCCRPolarArgument arga) (ContraCCRPolarArgument argb) =
    withInvertPolarity @polarity $ do
        MkShimWit argab conv <- f arga argb
        return $ MkShimWit (ContraCCRPolarArgument argab) $ mkContravariantPolarShim conv
