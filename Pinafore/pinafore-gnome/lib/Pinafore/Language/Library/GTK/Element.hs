...
layoutElementGroundType =
    stdSingleGroundType $(iowitness [t|'MkWitKind (SingletonFamily LangLayoutElement)|]) "LayoutElement.GTK."
...
elementStuff =
    headingBDS
        ...
        [ typeBDS
              ...
              []
        , typeBDS "LayoutElement" "An Element in the context of a layout." (MkSomeGroundType layoutElementGroundType) []
