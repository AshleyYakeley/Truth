module Truth.World.Pinafore.Query where
{
    ...
    {
        QBool :: QPrimitiveType Bool;
        QText :: QPrimitiveType Text;
        QInt :: QPrimitiveType Int;
    };
    ...
    data QType t where
    {
        ...
        QMorphism :: QPrimitiveType t -> QType (PinaforeLensMorphism Point t);
    ...
    instance TestEquality QType where
    {
        ...
        testEquality (QMorphism t1) (QMorphism t2) = do
        {
            Refl <- testEquality t1 t2;
            return Refl;
        };
