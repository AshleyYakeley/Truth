...
) where
{
    ...
    data FileState = MkFileState
    {
        ...
        fsPushout :: ContextContentEdit (WholeEdit FilePath) (JustRepEdit Maybe (WholeEdit ByteString)) -> IO (),
    ...
    newFileState :: INotifyB -> FilePath -> (ContextContentEdit (WholeEdit FilePath) (JustRepEdit Maybe (WholeEdit ByteString)) -> IO ()) -> IO FileState;
    ...
    linuxFileObject :: INotifyB -> FilePath ->
     Subscribe 
      (ContextContentEdit (WholeEdit FilePath) (JustRepEdit Maybe (WholeEdit ByteString)));
