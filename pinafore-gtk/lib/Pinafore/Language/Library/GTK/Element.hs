...
instance ToShimWit (PinaforePolyShim Type) (PinaforeSingularType 'Positive) LangElement where
    toShimWit = mkShimWit $ GroundDolanSingularType elementGroundType NilDolanArguments

instance ToShimWit (PinaforePolyShim Type) (PinaforeType 'Positive) LangElement where
    toShimWit = singleDolanShimWit toJMShimWit

instance FromShimWit (PinaforePolyShim Type) (PinaforeSingularType 'Negative) LangElement where
    fromShimWit = mkShimWit $ GroundDolanSingularType elementGroundType NilDolanArguments

instance FromShimWit (PinaforePolyShim Type) (PinaforeType 'Negative) LangElement where
...
instance ToShimWit (PinaforePolyShim Type) (PinaforeSingularType 'Positive) LangLayoutElement where
    toShimWit = mkShimWit $ GroundDolanSingularType layoutElementGroundType NilDolanArguments

instance ToShimWit (PinaforePolyShim Type) (PinaforeType 'Positive) LangLayoutElement where
    toShimWit = singleDolanShimWit toJMShimWit

instance FromShimWit (PinaforePolyShim Type) (PinaforeSingularType 'Negative) LangLayoutElement where
    fromShimWit = mkShimWit $ GroundDolanSingularType layoutElementGroundType NilDolanArguments

instance FromShimWit (PinaforePolyShim Type) (PinaforeType 'Negative) LangLayoutElement where
    fromShimWit = singleDolanShimWit fromJMShimWit
